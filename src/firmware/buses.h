 ...
 * @file buses.h
 * @author Juan
 * @brief Declaraciones buses de arquitectura de firmware de Control
 * @version 0.1
 * @date 2021-11-30
 *
...
#define ID_VOLTAJE_BMS				0x020	
#define	ID_CORRIENTE_BMS			0x021	
#define ID_VOLTAJE_MIN_CELDA_BMS 	0x022	
#define ID_POTENCIA_BMS				0x023	
#define ID_T_MAX_BMS				0x024
#define	ID_NIVEL_BATERIA_BMS		0x025	
